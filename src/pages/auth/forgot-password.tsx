...
const ForgotPass: NextPage = () => {
  ...
  return (
    <>
      <Head>
        <title>Coding4U | Forgot Password</title>
        <meta name="description" content="Forgot password coding4u" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <MainLayout>
        <Container mb={50}>
          <Text align="center" size={32} weight={600} color={`${colors.primaryColor}`}>Forgot Password?</Text>
