...
const ResetPage: NextPage = () => {
  ...
  return (
    <>
      <Head>
        <title>Coding4U | Reset Password</title>
        <meta name="description" content="Reset password Coding4U" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <MainLayout>
      <Container mb={50}>
          <Text align="center" size={32} weight={600} color={`${colors.primaryColor}`}>Reset Password</Text>
