                        ...
                        <Grid.Col md={4} style={{height: '100%'}}>
                            <Stack align="center">
                                <Card className={classes.cardShadow} radius={40}>
                                    ...
                                    <Text align="center" size={24} weight={600} color={`${colors.primaryColor}`}>Machine Learning</Text>
                                    <Text mt={20}>
                                        Our AI and Machine Learning Course offers a comprehensive curriculum that covers the latest techniques and tools in this exciting field. With hands-on projects and expert guidance, you'll build a solid foundation in deep learning, reinforcement learning, and ethical considerations, and be well-equipped to tackle real-world challenges. Join us and master the fundamentals of AI and machine learning today.
                                    </Text>
